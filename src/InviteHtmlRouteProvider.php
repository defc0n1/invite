...
/**
 * @file
 * Contains \Drupal\invite\InviteHtmlRouteProvider.
 */
...
class InviteHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\invite\Controller\InviteAddController::addForm',
          '_title_callback' => 'Drupal\invite\Controller\InviteAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\invite\Controller\InviteAddController::add',
